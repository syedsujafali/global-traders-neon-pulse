    ...
    <section id="contact" className="relative px-6 py-32">
      <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }}
          ...
          <span className="mb-4 inline-block text-sm tracking-widest text-neon-orange uppercase">Contact Us</span>
          <h2 className="mb-6 text-4xl font-black md:text-5xl">
            Let's <span className="text-gradient-neon">Connect</span>
          </h2>
          <p className="mb-10 text-muted-foreground leading-relaxed">
            Ready to transform your trading operations? Reach out and let's discuss how we can work together.
          </p>
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02, boxShadow: "0 0 30px oklch(0.80 0.22 150 / 40%)" }}
            whileTap={{ scale: 0.98 }}
          >
            Send Message
          </motion.button>
